...
/**
 * 简单序列号生成器，可用于各种低调用频率情况下单号的生成
 *
 * @author gaigeshen
 */
public class SimpleSerialNumberCreator implements SerialNumberCreator {

    public static final SimpleSerialNumberCreator INSTANCE = new SimpleSerialNumberCreator();
    ...
    private SimpleSerialNumberCreator() {
    }
